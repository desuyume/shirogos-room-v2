...
const FirstScreen: FC = () => {
	...
	return (
		<div className='bg-primaryText h-[729px] relative overflow-hidden'>
			...
			<img className={(isModalVisible ? 'visible opacity-100' : 'invisible opacity-0') + ' w-[24.616rem] h-[24.616rem] absolute -top-[1.08875rem] left-[50%] translate-x-[-134%] trab rotate-[-121.245deg] z-30 transition-all'} src={closeImg} alt='close-img' />
			<Socials />
