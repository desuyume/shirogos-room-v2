...
const OrderRules: FC<IOrderRules> = ({
	type,
	isRulesOpened,
	setIsRulesOpened,
}) => {
	...
	return (
		<div className='w-[23.28%] flex flex-col items-center transition-all z-20'>
			<img
				className={
					(isRulesHover ? 'mr-[2.2rem] ' : '') +
					' ml-[0.69rem] min-w-[13.5rem] h-[13.625rem]'
				}
			...
			<div
				...
				className='w-full h-[6.22319rem] bg-tertiary hover:bg-secondaryHover transition-all cursor-pointer bg-opacity-50 rounded-[1.5625rem] flex justify-center items-center group'
			>
				<p className='text-primaryText group-hover:text-white text-xl leading-[97.795%] text-center w-[11.25rem] transition-all'>
