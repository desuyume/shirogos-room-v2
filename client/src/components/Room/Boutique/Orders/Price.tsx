...
const Price: FC<IPrice> = ({ clickBuy, finalPrice }) => {
	return (
		<div className='w-[78.9%] h-[3.875rem] flex'>
			...
			<button
				onClick={clickBuy}
				className='w-[22.3%] h-full bg-primary hover:bg-primaryHover transition-all text-primaryText text-[1.0625rem] rounded-br-[1.5625rem]'
			>
				Купить
			</button>
		</div>
