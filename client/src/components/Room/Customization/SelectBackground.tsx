...
const SelectBackground: FC = () => {
	...
	return (
		<div className='h-[17.5rem] bg-room-gradient w-[78%] ml-[2%] rounded-[1.5625rem] py-[0.63rem] pl-[0.56rem] flex items-center select-bg'>
			<button className='min-w-[14.85%] max-w-[14.85%] bg-tertiary hover:opacity-95 transition-all h-full rounded-[1.0625rem] text-primaryText text-[0.9375rem] mr-10'>
				Выбрать фон
			</button>
						...
						>
							<img
								className={
									...
									'box-content min-w-[18.375rem] rounded-[1.5625rem] mb-2 pointer-events-none'
								}
								src={bg.img}
								alt='bg-img'
							/>
