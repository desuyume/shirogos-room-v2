...
const BackgroundAward: FC<IBackgroundAward> = ({ selectedAwardType, setBgImg }) => {
	...
	return (
		<div className={(selectedAwardType === 'background' ? 'block ' : 'hidden ') + 'w-full flex-1 flex justify-center items-center transition-all relative'}>
			<input
					ref={inputRef}
...
export default BackgroundAward