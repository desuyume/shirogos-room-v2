...
export const colorVariantsHover: Record<ColorTypeHover, Record<RoomColor, string>> = {
  bg: {
...
export const colorVariantsFocus: Record<ColorTypeFocus, Record<RoomColor, string>> = {
  border: {
...
export const colorVariantsDisabled: Record<ColorTypeDisabled, Record<RoomColor, string>> = {
  bg: {
...
export const colorVariantsGroupHover: Record<ColorTypeGroupHover, Record<RoomColor, string>> = {
  bg: {
...
export const colorVariantsMediumTablet: Record<ColorTypeMediumTablet, Record<RoomColor, string>> = {
  bg: {
