import { CHOOSE_FAVORITE_CHARACTER_KEY, FAVORITE_CHARACTER_KEY } from '@/consts/queryKeys'
...
export const useChooseFavoriteCharacter = () => {
  ...
  return useMutation(
    ...
    (data: IChooseFavoriteCharacter) => roomService.chooseFavoriteCharacter(data),
    {
      onSettled: () => {
