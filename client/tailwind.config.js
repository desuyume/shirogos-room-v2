  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'room-info-gray-gradient': 'linear-gradient(to bottom, #323232 0%, rgba(0, 0, 0, 0) 88%)',
        ...
        'black-to-secondary-gradient': 'linear-gradient(135deg, #000000 0%, #242424 100%)',
        'room-guide-screen-gradient': 'linear-gradient(180deg, #181818 0%, #640026 100%)',
